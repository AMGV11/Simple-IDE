...
public class NuevoArchivoWizardPanel1 implements WizardDescriptor.Panel<WizardDescriptor> {
    ...
    public void readSettings(WizardDescriptor wiz) {
       /* Project proyecto = (Project) wiz.getProperty("proyecto");
        if (getComponent() != null && proyecto != null) {
            boolean tiene = getComponent().comprobarPaquetes(proyecto);
            getComponent().mostrarAviso(!tiene);
            getComponent().setTienePaquetes(tiene);
        }    */
    }
