...
/**
 * Clase encargada del árbol de manuales.
 *
...
public final class ManualsExplorerTopComponent extends TopComponent {
    ...
    private void initializeTree() {
        ...
        manualsTree.expandRow(0);
        manualsTree.setCellRenderer(new ManualTreeCellRenderer());
        ...
        try {
            ...
            for (String pdfName : knownPDFs) {
                ...
                if (pdfURL != null) {
                    ...
                    ManualNode node = new ManualNode(displayName, fullPath);
                    parent.add(node);
                }
            }

        } catch (Exception e) {
            System.err.println("[ERROR] Error cargando manuales desde resources: " + e.getMessage());
            e.printStackTrace();
        }
    }
