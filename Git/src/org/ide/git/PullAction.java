    ...
    private void pullGitAction(Project selectedProject) {
        if (selectedProject != null) {
            ...
            try {
                ...
                if (exitCode == 0) {
                    System.out.println("[GIT] El comando PULL se ha ejecutado con éxito");
                } else {
                    AuxGit.printProcessErrors(p);
                    System.out.println("[GIT] El comando PULL ha tenido un error en su ejecución, mire el mensaje de consola");
                }
                p.waitFor();
