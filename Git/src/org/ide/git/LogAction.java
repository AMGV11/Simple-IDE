...
/**
 * Acción que manda el comando "git log" por consola.
 *
...
@ActionReference(path = "Menu/Git", position = 9013)
    ...
    private void commitGitAction(Project selectedProject) {
        if (selectedProject != null) {
            ...
            try {
                ...
                if (exitCode == 0) {
                    System.out.println("[GIT] El comando LOG se ha ejecutado con éxito");
                } else {
                    AuxGit.printProcessErrors(p);
                    System.out.println("[GIT] El comando LOG ha tenido un error en su ejecución, mire el mensaje de consola");
                }
